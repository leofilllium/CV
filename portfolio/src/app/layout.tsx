...
export const metadata: Metadata = {
  ...
  title: {
    default: "Sherzod Akhmedov | Middle Flutter & Full-stack Developer",
    template: "%s | Sherzod Akhmedov",
  },
  description:
    "Explore Sherzod Akhmedov’s work in Flutter, full-stack development, AI systems, and interactive games. Based in Tashkent. Open to remote and hybrid opportunities.",
  openGraph: {
    type: "website",
    locale: "en_US",
    siteName: "Sherzod Akhmedov",
    title: "Ideas into new worlds. Sherzod Akhmedov.",
    description: "Flutter. Full-stack. AI. Explore the work of a curious engineer.",
  },
